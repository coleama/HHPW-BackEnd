    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Apps", "Mmmm Cheese", "https://www.foxvalleyfoodie.com/wp-content/uploads/2015/07/homemade-mozzarella-sticks-320x320.jpg", "CheeseSticks", 9.99m });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Address", "Email", "FirstName", "IsCashier", "LastName", "uid" },
                values: new object[] { 1, "this is an address", "cole.ama@email.com", "Cole", true, "Amantea", "vyiiRAsqs6YvGQg6U8RtAoFW8iF2" });

            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "Id", "Content", "MenuItemId", "UserId" },
                values: new object[] { 1, "this is content", 1, 1 });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CustomerName", "CustomerPhoneNumber", "DatePlaced", "OrderStatusId", "OrderTypeId", "Tip", "UserId" },
                values: new object[] { 1, "Billy", "867-5309", new DateTime(2023, 10, 9, 18, 6, 36, 155, DateTimeKind.Local).AddTicks(9157), 1, 1, 4.01m, 1 });
